...
class CustomBookViewSerializer(serializers.ModelSerializer):
    ...
    room_no = serializers.ReadOnlyField(source='room_id.room_no')

    class Meta:
        model = Booking
        fields = ['id', 'room_id', 'room_no', 'guest_name', 'check_in_date', 'check_out_date', 'total_price']
...
#     class Meta:
#         model = Room
#         fields = ['hotel_id', 'room_no', 'room_type', 'price_per_night', 'is_available']
#
#     # def get_hotel_name(self, obj):
#     #     return obj.hotel_id.name if obj.hotel_id else None


class RoomAddSerilizer(serializers.ModelSerializer):
    class Meta:
        model = Room
        fields = ['hotel_id', 'room_no', 'room_type', 'price_per_night']
...
class RoomsAvailableSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Room
        fields = ['id', 'hotel_id', 'room_no', 'room_type', 'price_per_night']
